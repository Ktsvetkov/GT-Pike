...
- (void)getFacebookJsonData {
    ...
    dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_HIGH, 0), ^{
        ...
        NSString *postDataString = @"https://graph.facebook.com/v2.3/211408658879699/posts?access_token=488056298015418|ev5kTyKcCZU5sQD0s3za_nB9HhU";
...
- (void)getInstagramJsonData {
    
    dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_HIGH, 0), ^{
        
        NSString *postDataString = @"https://api.instagram.com/v1/users/1683349843/media/recent?access_token=40166568.3f950fc.ca331d73f4dd48398c6efa1d80962c19";
        ...
        dispatch_async(dispatch_get_main_queue(), ^{
            ...
            if (self.postData == nil) {
                ...
                NSArray *results = [parsedObject valueForKey:@"data"];
                for (NSDictionary *dic in results){
                    NSString *message = [(NSString *)[dic valueForKey:@"caption"]
                                                         valueForKey:@"text"];
                    NSString *dateString = (NSString*) [dic valueForKey:@"created_time"];
                    
                    NSString *pictureURL = @"";
                    pictureURL = [(NSString *)[[dic valueForKey:@"images"]
                                  valueForKey:@"standard_resolution"]valueForKey:@"url"];
                    ...
                    if (message != nil && dateString != nil) {
                        ...
                        [toAdd setTimeSince1970: [dateString intValue]];
                        [toAdd setMessage:message];
                        [toAdd setMediaType: @"instagram"];
                        [toAdd setPictureLinks:pictureLinks];
                        [self.posts addObject:toAdd];
